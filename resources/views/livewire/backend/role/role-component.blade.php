    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <div wire:click.prevent="createRole()" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary font-weight-bolder">
                {{-- <a href="{{route('admin.role.create-role')}}" class="btn btn-primary font-weight-bolder"> --}}
      ...
      <!-- Modal -->
      @if ($updateMode == false)
          @include('livewire.backend.role.create-role')
      @else
            @include('livewire.backend.role.edit-role')
      @endif
            ...
            $(document).ready(function(){
                window.addEventListener('contentChanged', event => {
                    ...
                    $('#kt_select2_3').on('change', function(e){
                        @this.set('permission', $(this).val().map(val => Number(val)))
                    })
                })
            })
        </script>
