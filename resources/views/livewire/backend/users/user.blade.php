            ...
            <tbody>
                @foreach ($users as $user)
                 <tr>
                    ...
                    <td>{{$user->email}}</td>
                    <td>
                        <img width="180px" src="{{asset("frontend/images/avatars/$user->avatar")}}"  alt="">
                    </td>
                    <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">{{$editRole}} Name User</label>
                    <input type="email" disabled value="{{$nameUser}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
