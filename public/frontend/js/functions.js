...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/frontend/css/style-dark-rtl.css');
          } else {
              style.setAttribute('href', '/frontend/css/style-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/frontend/css/style-rtl.css');
          } else {
              style.setAttribute('href', '/frontend/css/style.css');
          }
